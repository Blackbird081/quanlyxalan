...
> CVF Core: ../.Controlled-Vibe-Framework-CVF (resolve through .cvf/manifest.json or .cvf/local-binding.json)
> CVF Commit: 27137db4d9aa2aea931ddd2507185d5c24943080
> Bootstrap Date: 2026-07-27
> Project: quanlyxalan
...
- CVF core path (`../.Controlled-Vibe-Framework-CVF (resolve through .cvf/manifest.json or .cvf/local-binding.json)`) is **read-only reference** for this project.
...
5. `../.Controlled-Vibe-Framework-CVF (resolve through .cvf/manifest.json or .cvf/local-binding.json)/AGENT_HANDOFF.md` — current CVF state and active tranches
6. `../.Controlled-Vibe-Framework-CVF (resolve through .cvf/manifest.json or .cvf/local-binding.json)/AGENTS.md` — CVF-level mandatory governance proof rules
...
3. Generate a bridge receipt:
   ...
   ```powershell
   powershell -ExecutionPolicy Bypass -File "../.Controlled-Vibe-Framework-CVF (resolve through .cvf/manifest.json or .cvf/local-binding.json)\scripts\write_cvf_workspace_web_evidence_bridge.ps1" `

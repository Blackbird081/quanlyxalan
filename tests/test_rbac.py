...
_TEST_DB_URL = _pgdb.create_database("kbcv_rbac")
...
def test_alembic_t1_upgrade_and_downgrade_rehearsal(monkeypatch, pg_url):
...
def test_alembic_fresh_database_reaches_t2_head(monkeypatch, pg_url):
